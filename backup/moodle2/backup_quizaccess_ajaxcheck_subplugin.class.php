...
/**
 * Backup code for the quizaccess_ajaxcheck plugin.
 *
 * @package   quizaccess
...
/**
 * Provides the information to backup the ajaxcheck quiz access plugin.
 *
 ...
 */
class backup_quizaccess_ajaxcheck_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugin_table_settings = new backup_nested_element('quizaccess_ajaxcheck',
                null, array('ajaxcheck'));
        ...
        $subplugin_table_settings->set_source_table('quizaccess_ajaxcheck',
